...
object NetflixPrizePartialMVM extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("NetflixPrizePartialMVM") {
      head("NetflixPrizePartialMVM: an example app for PartialMVM.")
      ...
      note(
        """
          ...
          |
          | bin/spark-submit --class com.github.cloudml.zen.examples.ml.NetflixPrizePartialMVM \
  ...
  def run(params: Params): Unit = {
    ...
    SparkHacker.gcCleaner(60 * 10, 60 * 10, "NetflixPrizePartialMVM")
