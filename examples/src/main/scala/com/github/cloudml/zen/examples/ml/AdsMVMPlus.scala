...
object AdsMVMPlus extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("MVMPlus") {
      head("AdsMVMPlus: an example app for MVMPlus.")
      ...
      note(
        """
          ...
          |
          | bin/spark-submit --class com.github.cloudml.zen.examples.ml.MVMPlus \
  ...
  def run(params: Params): Unit = {
    ...
    SparkHacker.gcCleaner(60 * 15, 60 * 15, "AdsMVMPlus")
    ...
    val lfm = new MVMPlusClassification(trainSet, stepSize, views, regular, 0.0, rank,
