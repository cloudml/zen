...
class TFModel(
  ...
  override def save(sc: SparkContext, path: String): Unit = {
    TFModel.SaveLoadV1_0.save(sc, path, k, views, classification, factors)
  }

  override protected def formatVersion: String = TFModel.SaveLoadV1_0.formatVersionV1_0
}

object TFModel extends Loader[TFModel] {

  override def load(sc: SparkContext, path: String): TFModel = {
    ...
    if (loadedClassName == classNameV1_0 && version == versionV1_0) {
      ...
      new TFModel(k, views, classification, factors)
    } else {
      throw new Exception(
  ...
  private object SaveLoadV1_0 {
    ...
    val classNameV1_0 = "com.github.cloudml.zen.ml.recommendation.TFModel"
